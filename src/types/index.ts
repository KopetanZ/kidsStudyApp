...
export interface UserProgress {
  ...
  pokemonCollection?: number[]; // 獲得したポケモンIDのリスト
  shinyCounts?: Record<number, boolean>; // シャイニーポケモンの記録
  favoritePokemon?: number; // お気に入りポケモンID
}
